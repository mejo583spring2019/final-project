 ...
 * mixed completion rates at particular
  ...
  constructor(props) {
    ...
    this.fullData.forEach((s) => {
      if (s["school.name"] !== "Appalachian Bible College") {
        if (s !== undefined &&
          s["latest.completion.completion_rate_4yr_150_2ormore"] !== null) {
          schoolName.push(s["school.name"]);
          mixedCompletion.push(
              (s["latest.completion.completion_rate_4yr_150_2ormore"] * 100)
          );
        }
      }
    });
    ...
    this.type = "column";
    this.chartData = mixedCompletion;
    this.title = "Completion Rates of Mixed Students";
    ...
    this.options = {
      ...
      series: [
        {
          name: "Completion rate of Mixed students",
          data: this.chartData,
        },
      ],
    };
